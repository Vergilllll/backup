...
public:
    ...
    void setupUi(QDialog *Filefilter)
    {
        ...
        gridLayout->addWidget(maxSizeTextBox, 7, 1, 1, 1);
        ...
        gridLayout->addWidget(minSizeTextBox, 6, 1, 1, 1);
        ...
        startTimeEdit = new QDateTimeEdit(layoutWidget);
        startTimeEdit->setObjectName(QString::fromUtf8("startTimeEdit"));

        gridLayout->addWidget(startTimeEdit, 4, 1, 1, 1);

        endTimeEdit = new QDateTimeEdit(layoutWidget);
        endTimeEdit->setObjectName(QString::fromUtf8("endTimeEdit"));

        gridLayout->addWidget(endTimeEdit, 5, 1, 1, 1);
