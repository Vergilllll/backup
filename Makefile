...
# Project:  bak.pro
# Template: app
# Command: D:\QT\5.9.9\mingw53_32\bin\qmake.exe -o Makefile bak.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: bak.pro ../mkspecs/win32-g++/qmake.conf ../mkspecs/features/spec_pre.prf \
		../mkspecs/qdevice.pri \
